...
var btnDecrease = document.querySelector('#toggle'); //액션 타입과 액션 생성 함수 정의

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE';

var toogleSwitch = function toogleSwitch() {
  return {
    type: TOGGLE_SWITCH
  };
};
...
var store = createStore(reducer); //render 함수 만들기 이 함수는 상태가 업데이트될 때만다 호출

var render = function render() {
  var state = store.getState(); // 현재 삳태를 불러 옵니다.
  //토글처리
